...
export function Modal({ entradumSeleccionado, handleConfirmarEliminar }) {
    return (
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        {entradumSeleccionado && (
                            <p>¿Estás seguro de que deseas eliminar al entrada con el proveedor {entradumSeleccionado.proveedor} y el producto {entradumSeleccionado.idProductos}?</p>
                        )}
                    </div>
